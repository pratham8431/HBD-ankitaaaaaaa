...
new TypeIt("#teks1", {
  strings: [
    "Happy birthday Sonaaa. 23!!",
    "Another year another birthday but still you are my favourite person throughout all the years and you would continue to be that (until my girl arrives (jk)).",
    "You are my sukoon!!",
    "You are the only girl that makes me laugh, you are the only girl i listen to almost everything and you are the girl i am afraid of the most —",
    "ANKITA BOLA KARNEKA TOH KARNEKA 😭",
    "IDK why i said this but yeahh i would never go against your word!"
  ],
  startDelay: 4000,
  speed: 60,
  waitUntilVisible: true
